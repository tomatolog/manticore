...
-  added `ALTER <../alter_syntax.html>`__ RTINDEX rt1 RECONFIGURE which
   allows to change RT index settings on the fly

-  added `SHOW INDEX idx1 SETTINGS <../show_index_settings_syntax.html>`__
   statement
...
-  added
   `ANY() <../5_searching/expressions,_functions,_and_operators/miscellaneous_functions.html#expr-func-any>`__/`ALL() <../5_searching/expressions,_functions,_and_operators/miscellaneous_functions.html#expr-func-all>`__/`INDEXOF() <../5_searching/expressions,_functions,_and_operators/miscellaneous_functions.html#expr-func-indexof>`__
...
-  added ``LIMIT`` clause for the `FACET <../select_syntax.html>`__
   keyword

-  added JSON-formatted output to ``PACKEDFACTORS()`` function

-  added #1999
   `ATAN2() <../5_searching/expressions,_functions,_and_operators/miscellaneous_functions.html#expr-func-atan2>`__
   function
...
-  added ``searchd`` configuration keys
   ...
   `agent\_retry\_count <../searchd_program_configuration_options/agentretry_count.html>`__
   and
   `agent\_retry\_delay <../searchd_program_configuration_options/agentretry_delay.html>`__

-  `GROUPBY() <../select_syntax.html>`__ function now returns strings for
   string attributes
...
-  fixed #1970, speeding up `ZONE and
   ZONESPAN <../extended_query_syntax.html>`__ operators
...
-  fixed #2021, output units in
   `GEODIST() <../5_searching/expressions,_functions,_and_operators/miscellaneous_functions.html#expr-func-geodist>`__
   function
...
-  fixed #1966,
   `INTERVAL() <../5_searching/expressions,_functions,_and_operators/comparison_functions.html#expr-func-interval>`__
