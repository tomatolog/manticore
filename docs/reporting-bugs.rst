...
`Prev <sphinxse-snippets.html>`__ 
 
 `Next <conf-reference.html>`__
...
+-------------------------------------------------+-------------------------+--------------------------------------------------+
| `Prev <sphinxse-snippets.html>`__               |                         |  `Next <conf-reference.html>`__                  |
+-------------------------------------------------+-------------------------+--------------------------------------------------+
| 10.4. Building snippets (excerpts) via MySQL    | `Home <index.html>`__   |  Chapter 12. ``sphinx.conf`` options reference   |
+-------------------------------------------------+-------------------------+--------------------------------------------------+
