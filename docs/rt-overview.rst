...
`Prev <rt-indexes.html>`__ 
Chapter 4. Real-time indexes
 `Next <rt-caveats.html>`__
...
.. rubric:: 4.1. RT indexes overview
   :name: rt-indexes-overview
   :class: title
...
+---------------------------------+----------------------------+---------------------------------------+
| `Prev <rt-indexes.html>`__      | `Up <rt-indexes.html>`__   |  `Next <rt-caveats.html>`__           |
+---------------------------------+----------------------------+---------------------------------------+
| Chapter 4. Real-time indexes    | `Home <index.html>`__      |  4.2. Known caveats with RT indexes   |
+---------------------------------+----------------------------+---------------------------------------+
