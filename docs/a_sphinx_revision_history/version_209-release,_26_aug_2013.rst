...
-  fixed #1651, `CREATE FUNCTION <../create_function_syntax.html>`__ can
...
-  fixed #1581,
   `dict=keywords <../index_configuration_options/dict.html>`__ and
...
-  fixed #1531, #1589, several matching and highlighting issues when
   using both
   `blend\_chars <../index_configuration_options/blendchars.html>`__ and
   multi-wordforms
...
-  fixed #1346, `NEAR <../extended_query_syntax.html>`__ handles
...
-  fixed that `CALL KEYWORDS <../call_keywords_syntax.html>`__
   occasionally gave incorrect error messages

-  fixed searchd crashes on `ATTACHing <../attach_index_syntax.html>`__
...
-  optimized `xmlpipe2 <../xmlpipe2_data_source.html>`__ indexing
