...
`agent <../../index_configuration_options/agent.html>`__ directive. The
...
limited by
`persistent\_connections\_limit <../../searchd_program_configuration_options/persistentconnections_limit.html>`__
