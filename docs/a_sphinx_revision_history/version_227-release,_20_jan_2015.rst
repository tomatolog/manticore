...
-  added #2112, string equal comparison support for
   `IF() <../5_searching/expressions,_functions,_and_operators/comparison_functions.html#expr-func-if>`__
...
-  fixed #2155,
   `stopwords <../index_configuration_options/stopwords.html>`__ got
...
-  fixed #2003,
   `lemmatize\_XX\_all <../index_configuration_options/morphology.html>`__
...
-  fixed seamless rotation in
   `prefork <../searchd_program_configuration_options/workers.html>`__
   mode

-  fixed snippets crash with `blend
   chars <../index_configuration_options/blendchars.html>`__ at the
